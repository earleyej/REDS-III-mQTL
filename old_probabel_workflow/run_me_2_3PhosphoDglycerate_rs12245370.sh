...
export METABOLITE="2_3PhosphoDglycerate_rs12245370"
...
export processingDir=/share/storage/REDS-III/RBCOmics/metabolomics/processing/${METABOLITE}/conditional_rs12245370
export phenoDir=/share/storage/REDS-III/RBCOmics/metabolomics/processing/${METABOLITE}
