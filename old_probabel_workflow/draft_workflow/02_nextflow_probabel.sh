...
export PHENO_FILE="phenotype_ATP_N12592_20230502.txt"
export PHENO="ATP"
...
for (( chr=7; chr<24; chr++ )); do
        out_file=$working_dir/processing/${PHENO}_rbc.all.1000G_p3.chr${chr}.age_gender_hub_donate_evs_SNP.stats
        geno_prefix=rbc.ALL.1000G_p3.chr
                ...
                --working_dirs $working_dir/processing \
                --out $out_file \
                --method $method
  done
